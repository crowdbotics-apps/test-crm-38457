"""
Django settings for test_crm_38457 project.
...
ROOT_URLCONF = 'test_crm_38457.urls'
...
WSGI_APPLICATION = 'test_crm_38457.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_crm_38457 API",
    "DESCRIPTION": "API documentation for test_crm_38457 App",
    "VERSION": "v1",
}
